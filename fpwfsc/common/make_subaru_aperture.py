...
def generate_pupil(
    ...
    return pupil.shaped, PUPIL_DIAMETER


def get_aperture(pupil_grid = None, rotation_angle_aperture = None, aperturename = 'subaru', oversampling_factor=8):



    aperture_field = evaluate_supersampled(generate_pupil(),pupil_grid,)
    
    pdb.set_trace()


    return aperture_field, PUPIL_DIAMETER
