...
if __name__ == "__main__":
    ...
    # firstim = Detector.take_image()#works, tested
    ...
    for kvecr in kr:
        ...
        # status = AOsystem.set_dm_shape((initial_dm_shape + additionmap))
        # status = KeckSim.set_dm_shape((initial_dm_shape + additionmap))
        print(additionmap)
        KeckSim.set_dm_shape((initial_dm_shape + additionmap))
        # im = Detector.take_image()
