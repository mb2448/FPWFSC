...
with pf.open('./NIRC2_test_img/subaru_procimg_01.fits') as hdul:
    data = hdul[0].data


x,y  =     contrastcurve_simple(data, cx=None, cy = None, sigmalevel = 1, robust=True, region =None, maxrad = 30)
